...
export const submitAnalysisFeedback = (profileId, confirmed) =>
  api.post('/analyze/feedback', { profile_id: profileId, confirmed });
...
export const adminDeleteReport = (reportId) => api.delete(`/admin/reports/${reportId}`);
