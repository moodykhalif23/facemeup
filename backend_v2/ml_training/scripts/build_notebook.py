...
"import sys, os\n",
NL,
"# ml_service MUST be installed first\n",
"!pip install -q -e ml_service\n",
"!pip install -q -e ml_training\n",
NL,
"# Add ml_service to sys.path explicitly — pip editable installs are sometimes\n",
"# unreliable in Colab subprocesses. PYTHONPATH ensures precompute subprocess works.\n",
"ML_SERVICE_PATH = os.path.abspath('ml_service')\n",
"if ML_SERVICE_PATH not in sys.path:\n",
"    sys.path.insert(0, ML_SERVICE_PATH)\n",
"os.environ['PYTHONPATH'] = ML_SERVICE_PATH\n",
NL,
"ok = True\n",
...
code(
"import os\n",
"SOURCE = 'scin_hf'   # start with scin_hf to verify; then change to 'all'\n",
NL,
"# PYTHONPATH ensures the subprocess finds ml_service's 'app' module\n",
"ML_PATH = os.path.abspath('ml_service')\n",
"os.environ['PYTHONPATH'] = ML_PATH\n",
NL,
"!PYTHONPATH={ML_PATH} python -m skin_training.data.precompute \\\n",
"  --source {SOURCE} \\\n",
"  --output /content/work \\\n",
"  --aligned-size 256 \\\n",
"  --verbose 2>&1 | tail -80",
