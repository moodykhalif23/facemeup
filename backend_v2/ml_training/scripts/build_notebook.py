...
"# ml_service MUST be installed first — precompute imports its face pipeline\n",
"!pip install -q -e ml_service\n",
"!pip install -q -e ml_training\n",
NL,
"# Verify both are importable before proceeding\n",
"import importlib, sys\n",
"for pkg, symbol in [('app.config','get_settings'), ('skin_training.data.sources.scin_hf','FACE_MULTIHOT_COLS')]:\n",
"    try:\n",
"        mod = importlib.import_module(pkg)\n",
"        print(f'OK {pkg}.{symbol} =', getattr(mod, symbol, '(loaded)'))\n",
