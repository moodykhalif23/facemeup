...
"## Face-Only Cosmetics Training: SCIN + GlowMix\n",
NL,
...
"2. Get a **read token** from https://huggingface.co/settings/tokens\n",
"3. Download GlowMix from Kaggle: https://www.kaggle.com/datasets/drishyatomar/glowmix-merged-facial-skincare-dataset\n",
"4. Push repo to GitHub, fill `GITHUB_USER` in Cell 1\n",
NL,
"| Source | Total images | After face/neck filter |\n",
"|---|---|---|\n",
"| `google/scin` | ~10k | ~1-3k |\n",
"| `glowmix` | face-only cosmetics labels | no body-part filtering needed |\n",
"| **Combined** | **SCIN face-only + GlowMix face-only** | **best match for cosmetics** |",
),
...
md(
"## 3b. Download GlowMix From Kaggle\n",
"\n",
"GlowMix is already face-only and maps better to cosmetic concerns, including\n",
"dark circles. This cell downloads the Kaggle archive into `/content/datasets/glowmix`.\n",
),
code(
"from pathlib import Path\n",
"from google.colab import files\n",
"import os, zipfile\n",
"KAGGLE_DATASET = 'drishyatomar/glowmix-merged-facial-skincare-dataset'\n",
"KAGGLE_DIR = Path('/root/.kaggle')\n",
"KAGGLE_JSON = KAGGLE_DIR / 'kaggle.json'\n",
"if not KAGGLE_JSON.is_file():\n",
"    print('Upload your kaggle.json API key file from https://www.kaggle.com/settings')\n",
"    uploaded = files.upload()\n",
"    if 'kaggle.json' not in uploaded:\n",
"        raise FileNotFoundError('kaggle.json upload required to download GlowMix')\n",
"    KAGGLE_DIR.mkdir(parents=True, exist_ok=True)\n",
"    KAGGLE_JSON.write_bytes(uploaded['kaggle.json'])\n",
"    os.chmod(KAGGLE_JSON, 0o600)\n",
"!pip install -q kaggle\n",
"!mkdir -p /content/datasets/glowmix\n",
"!kaggle datasets download -d {KAGGLE_DATASET} -p /content/datasets/glowmix --unzip\n",
"!find /content/datasets/glowmix -maxdepth 2 -type d | head -40",
),

md(
"## 4. Precompute aligned face tensors  (~20-60 min)\n",
NL,
"Streams SCIN from HuggingFace and reads GlowMix from a local Kaggle extract, then runs:\n",
...
"|---|---|\n",
"| `scin_hf` | SCIN only |\n",
"| `glowmix` | GlowMix only |\n",
"| `all_face_cosmetic` | SCIN face-only + GlowMix (recommended) |\n",
NL,
"Fully resumable - re-run to continue.",
),
code(
"import os\n",
"SOURCE = 'all_face_cosmetic'   # recommended: SCIN face-only + GlowMix face-only\n",
"GLOWMIX_ROOT = '/content/datasets/glowmix'\n",
NL,
...
"if n < 300:\n",
'    print("\\n[!] Very few samples - prefer adding more GlowMix faces rather than all-body-parts")',
),
